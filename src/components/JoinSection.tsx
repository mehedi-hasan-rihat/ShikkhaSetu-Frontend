                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-purple-100 rounded-2xl p-8 flex items-center gap-6">
                        <div className="flex-1">
                            ...
                            <Link href="/register?role=student" className="bg-[#0AB5F8] text-white px-6 py-3 rounded-lg hover:bg-[#0891b2] transition-colors cursor-pointer">
                                Join as a student
                            </Link>
                        </div>
                    ...
                    <div className="bg-purple-200 rounded-2xl p-8 flex items-center gap-6">
                        <div className="flex-1">
                            ...
                            <Link href="/register?role=tutor" className="bg-[#0AB5F8] text-white px-6 py-3 rounded-lg hover:bg-[#0891b2] transition-colors cursor-pointer">
                                Join as a tutor
                            </Link>
                        </div>
                        <div className="shrink-0">
